  ...
  return (
    <div className="page-wrapper">
      <div className="container">
        ...
        <Image
          src="/images/blog/09/Best-pre-wedding-locations-in-mumbai-1-1.jpg"
        ...
        {/* ================= 3 ================= */}
        <h3 className="b-h3">
          Unveil Your Love Story at Iconic Pre Wedding Venues in Mumbai
        </h3>
        ...
        {/* ================= 3 ================= */}
        <h3 className="b-h3">
          Top 10 Dreamy Pre Wedding Locations in Mumbai for a Stunning Shoot
        </h3>
        ...
        <div className="content mt-4">
          ...
          <p>
            ...
            public places are{" "}
            <Link href="https://en.wikipedia.org/wiki/Gateway_of_India" scroll={false}>
              <b>
                <u className="text-[#fd9b48]"> Gateway of India </u>
              </b>
            </Link>{" "}
            and <Link href="https://en.wikipedia.org/wiki/Marine_Drive,_Mumbai" scroll={false}><b><u className="text-[#fd9b48]"> Marine Drive </u></b></Link> to serene settings such as{" "}
            <Link href="https://en.wikipedia.org/wiki/Sanjay_Gandhi_National_Park" scroll={false}>
              <b>
                <u className="text-[#fd9b48]"> Sanjay Gandhi National Park </u>
              </b>
            </Link>{" "}
            and <Link href="https://en.wikipedia.org/wiki/Powai_Lake" scroll={false}><b><u className="text-[#fd9b48]"> Powai Lake </u></b></Link>, the city offers a variety of picturesque spots.
            Historic South Mumbai contrasts with the modern flair of <Link href="https://en.wikipedia.org/wiki/Castella_de_Aguada" scroll={false}><b><u className="text-[#fd9b48]"> Bandra Fort </u></b></Link>
            and <Link href="https://en.wikipedia.org/wiki/Worli" scroll={false}><b><u className="text-[#fd9b48]"> Worli Sea Face </u></b></Link>, while <Link href="https://en.wikipedia.org/wiki/Juhu" scroll={false}><b><u className="text-[#fd9b48]"> Juhu </u></b></Link> and <Link href="https://en.wikipedia.org/wiki/Versova,_Mumbai" scroll={false}><b><u className="text-[#fd9b48]"> Versova beaches </u></b></Link> add coastal
            charm.
          </p>
        </div>
        ...
        <h3 className="b-h3">
          The Ultimate Guide to Stunning Pre Wedding Settings in Mumbai
        </h3>
        ...
        <Image
          src="/images/blog/09/Best-pre-wedding-locations-in-mumbai-2-1.jpg"
        ...
        <h3 className="b-h3">
          Capturing Romance: Exclusive Pre Wedding Locations in Mumbai
        </h3>
        ...
        <h3 className="b-h3">
          Glamour and Elegance: Premier Pre Wedding Locations in Mumbai
        </h3>
