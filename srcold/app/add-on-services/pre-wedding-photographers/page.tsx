...
export default function PreWeddingPhotographers() {
  ...
  Expert Pre Wedding Photographers For You!
</h1>
        ...
        <p className="text-[#74405B] mb-6">
          Our in house team of photographers shooting at our locations with good experience.
        </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex items-center gap-3 font-['Quicksand'] text-[18px] font-bold text-[#74405B]">
            <span>📸</span>
            <span>In House Photographers</span>
          </div>

          <div className="flex items-center gap-3 font-['Quicksand'] text-[18px] font-bold text-[#74405B]">
            <span>🖼️</span>
            <span>View our photographers sample work</span>
          </div>

          <div className="flex items-center gap-3 font-['Quicksand'] text-[18px] font-bold text-[#74405B]">
            <span>💰</span>
            <span>Cost - Rs 20,000</span>
          </div>
  ...
  >
    OUR WORK
        ...
        {/* Lorem Ipsum Content */}
        <div className="space-y-8 text-[#74405B] font-medium leading-8 text-[15px]">
          <p className="pheight">
